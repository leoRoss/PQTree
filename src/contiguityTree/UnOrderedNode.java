...
public class UnOrderedNode extends InnerNode {
	...
	protected boolean sameType (Node node) {return node instanceof UnOrderedNode;}
	public boolean isOrdered () {return false;}
	public boolean isReversible () {return false;}
	
	protected String name () {return "Unordered InnerNode";}
	protected Collection<Node> getSubTasksForEfficientTraversal (){ return subNodes; }
}
