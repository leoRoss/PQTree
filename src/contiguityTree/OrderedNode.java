...
public class OrderedNode extends InnerNode {
    ...
    private Node getSubTask (int index) { return orderedSubNodes.get(index); }
    private List<Node> getOrderedSubNodes(){return orderedSubNodes;}
    ...
    protected Collection<Node> getSubTasksForEfficientTraversal (){ return getOrderedSubNodes();}
